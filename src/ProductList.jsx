   ...
   const handleContinueShopping = (e) => {
    ...
    return (
        <div>
            ...
            <div className="tag">
               ...
               <a href="/" style={{textDecoration:'none'}}>
                        <div>
                    <h3 style={{color:'white'}}>Kent's Nursery</h3>
                        ...
                        <h1 className='cart'>
                            <label 
                                style={{
                                    ...
                                    left: "50%",  // Aligns the label to the center horizontally
                                    transform: "translateX(-50%)", // Centers the label horizontally
                                    fontSize: "1.5rem",
                                    cursor: "pointer",
                                    color: "white", // Ensure the label is visible if the cart icon is dark
                                }}
                            >
                                {totalItems()}
                            </label>
        ...
        <div className="product-grid">
            <br></br>
            {plantsArray.map((item, index)=><div className='mainCategoryDiv' key={index}> <h1>{item.category}</h1> 
            <div className="product-list">
            {item.plants.map((plant, indexPlant)=>
                <div className='product-card' key={indexPlant}>
