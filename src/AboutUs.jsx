...
function AboutUs() {
  return (
    <div className="about-us-container">
      ...
      <p className="about-us-description">Welcome to Kent's Nursery, where green meets serenity!</p>
      <p className="about-us-content">
        At Kent's Nursery, we are passionate about bringing nature closer to you. Our mission is to provide a wide range of 
      ...
      <p className="about-us-content">
        Join us in our mission to create a greener, healthier world. Visit Kent's Nursery today and experience the 
